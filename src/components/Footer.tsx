...
const Footer = React.memo(function Footer() {
  ...
  const socialButtonClass =
    "font-mono text-sm text-gray-400 hover:text-[#3ecf8e] hover:border-[#3ecf8e]/40 transition-all duration-300 flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#121212]/80 border border-[#2e2e2e]/50 min-h-11";
  ...
  return (
    <footer 
      className="relative w-full py-12 sm:py-16 px-4 border-t border-[#2e2e2e]/20 bg-[#121212] z-10 overflow-hidden" 
      ...
      <div className="max-w-6xl mx-auto grid gap-x-8 gap-y-6 footer-grid">
        ...
        <div className="footer-area-brand flex flex-col items-center gap-1 text-center">
          <div className="flex items-center gap-3">
            <div className="w-12 h-14 flex items-center justify-center bg-[#2e2e2e]/30 rounded-xl border border-[#3ecf8e]/10">
              <MiniLogo />
            </div>
        ...
        <div className="footer-area-sitemap">
          <h3 className="font-mono text-[10px] text-[#3ecf8e] uppercase tracking-[0.18em] mb-3">
            {sitemapHeading}
          </h3>
          <nav className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 items-start">
            {FOOTER_SITEMAP_PAGES.map((page) => (
              <button
                ...
                className="text-left font-sans text-sm text-gray-400 hover:text-[#3ecf8e] transition-colors cursor-pointer leading-6"
              >
        ...
        <div className="footer-area-social flex flex-col gap-3 footer-btn-rect lg:justify-end">
          <div className="footer-btn-row">
            {socialLinks.slice(0, 2).map(({ href, label, Icon }) => (
              ...
              >
                <span className="inline-flex items-center justify-center w-11 h-11 rounded-xl bg-[#121212]/60 border border-[#3ecf8e]/30 text-[#3ecf8e] shrink-0">
        ...
        <div className="text-center md:text-left flex flex-col items-center md:items-start gap-1 max-w-full footer-area-legal">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 mt-1.5 max-w-full">
            <button 
              ...
              className="font-sans text-xs sm:text-sm text-gray-400 hover:text-[#3ecf8e] hover:underline cursor-pointer transition-colors break-words text-center md:text-left"
            >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 inline-flex items-center gap-1.5 font-mono text-[11px] text-gray-400 hover:text-[#3ecf8e] transition-colors"
          >
